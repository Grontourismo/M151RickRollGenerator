...
-- Exportiere Daten aus Tabelle rickrollgeneratorm151.countrystats: ~0 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle rickrollgeneratorm151.pranks: ~0 rows (ungefähr)
DELETE FROM `pranks`;
